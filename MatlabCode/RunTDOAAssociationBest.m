...
cd('E:\Spatial-Context\Scripts Sans GPL')

% Parameters
fs =2000;

% List of sound files
cwd ='E:\Data\DCLDE2013\DCLDE_2013_10Channel\Day1';
cwd = 'E:\Data\DCLDE2013\DCLDE_2013_10Channel\All';
file_list=(  dir(fullfile(cwd, '*.aif')));


detectionsLocation = 'E:\Data\DCLDE2013\NN_output'
...
dclde_2013_meta = xlsread('E:/DCL2013_NEFSC_SBNMS_200903_metadata.xlsx');
...
%% Load the truth data
truthFiles = dir('E:\Data\DCLDE2013\LogsWithNewSNR\RavenST\CorrectChannels\*.csv');
...
% For detections with cross correlation scores above the threshold,
% assign assign the scores to the highest score in the cluster
...
%legend({'Temporal Clustering', 'TDOA Method', 'Baseline Detector' })
%%
